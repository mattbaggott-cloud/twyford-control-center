...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona 5-7 noticias más relevantes para el nicho de Matt",
  ...
  },
  {
    ...
    steps: [
      ...
      "Evalúa si el trend es relevante para el canal de Matt",
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona tema con mayor potencial de engagement para la audiencia de Matt",
      "Redacta post de LinkedIn en la voz de Matt (profesional-cercano, sin emojis ni hashtags)",
  ...
  },
  {
    ...
    description: "Digest curado de las newsletters del día. Consolida lo mejor de las suscripciones de Matt en un resumen accionable.",
  ...
  },
  {
    ...
    description: "Categoriza y resume los emails del día para que Matt empiece la jornada sin inbox anxiety.",
    schedule: "7:45h (cada día)",
    trigger: "cron",
    status: "active",
    steps: [
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Matt envía /cfo, /cmo, /cto, /legal, /growth, /coach o /producto",
      "Twyfordas carga el skill advisory-board/SKILL.md",
      "Lee el archivo de memoria del advisor correspondiente (memory/advisors/)",
      "Responde en la voz y personalidad del advisor con contexto de Matt",
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Comprueba si hay cambios en el workspace de Twyfordas",
  ...
  },
  {
    ...
    description: "Sesión autónoma nocturna que implementa mejoras en Twyford Holdings Control Center según el ROADMAP o inventa features nuevas útiles.",
    schedule: "3h (cada noche)",
    trigger: "cron",
    status: "active",
    steps: [
      "Lee ROADMAP.md de Twyford Holdings Control Center para seleccionar la siguiente feature",
      ...
      "Notifica a Matt por Telegram con el resumen de lo implementado",
    ],
  },
];
