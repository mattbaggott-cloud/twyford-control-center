    ...
    <div className="fixed inset-0 bg-gray-900" style={{ height: '100vh', width: '100vw' }}>
        ...
        <Suspense fallback={
          ...
          {AGENTS.map((agent) => (
            <AgentDesk
              key={agent.id}
              agent={agent}
              state={agentStates[agent.id] || { id: agent.id, status: 'idle' as AgentStatus }}
      ...
      {selectedAgent && (
        <AgentPanel
          ...
          state={agentStates[selectedAgent] || { id: selectedAgent, status: 'idle' as AgentStatus }}
                  ...
                  <div className="bg-gray-800 p-4 rounded border border-gray-700">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2">
                        ...
                        <span>Phase 0: Twyford Control Center Shell</span>
                      </li>
                      <li className="flex items-center gap-2">
